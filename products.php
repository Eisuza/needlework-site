<?php
    ...
    $template .= file_get_contents("contents/products.php");
    ...
    $template = preg_replace('/{PRODUCTS_SLOGAN}/', $add_elements['products_slogan'], $template);
    
    $elements = get_data_array($link, 'navigation');

    $products = get_data_array($link, 'products');
